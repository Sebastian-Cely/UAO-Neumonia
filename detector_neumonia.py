...
class App:
    def __init__(self):
        ...
        # Tamaño y características de la ventana
        ...
        # Variables String para contener el ID y el resultado
        self.ID = StringVar()
        ...
        # Posiciones de los elementos visuales
...
>>>>>>> 166ab163301804f0ebc32383dc0bf426f32ef836
    ...
    # Correr el modelo de predicción
    def run_model(self):
    ...
    # Creación de PDF con resultados
    def create_pdf(self):
